...
deliverable is **pure** (stdlib + the pure plot modules, no cairn app/server
...
`-`/`*` bullet lists, fenced code, `[text](url)` links) — cairn has no
markdown dependency today, and a report preview does not need a full parser.
"""
