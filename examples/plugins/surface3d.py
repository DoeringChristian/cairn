...
"""
Cairn Python plugin: Interactive 3D surface plot.

Expects artifact data as a flat Float32Array with metadata:
  { "rows": N, "cols": M, "x_label": "x", "y_label": "y", "z_label": "loss" }

matplotlib's wasm_backend renders an interactive 3D figure directly in the
browser (drag to orbit, scroll to zoom).
"""
